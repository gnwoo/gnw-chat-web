...
import authStatus from "./authHelper.js";
...
function Chats() {
  ...
  return (
    ...
    >
      <Box gridArea="chats" border="right">
        <Box height="7%" justify="center" align="center" border="bottom">
          <Text weight="bold" size="16px">Chats</Text>
        </Box>
        <Box height="93%" pad={{ left: "5px" }} overflow="auto">
          <List data={ongoingChats} margin={{ top: "-1px" }} pad={{ }}>
            {(chat, index) => (
